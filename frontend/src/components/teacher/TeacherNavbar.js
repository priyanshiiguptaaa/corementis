...
const TeacherNavbar = ({ 
  ...
  const navItems = [
    ...
    { id: 'schedule', label: 'Schedule Classes', icon: '📆' },
    { id: 'assignments', label: 'Assignments', icon: '📝' },
    { id: 'performance', label: 'Student Performance', icon: '📊' },
    { id: 'resources', label: 'Upload Resources', icon: '📤' },
    ...
    <>
      ...
      >
        ...
        <div className="hidden md:flex items-center p-4 border-b border-intel-blue/30">
          ...
          <span className="ml-2 text-sm bg-intel-blue px-2 py-0.5 rounded">Teacher</span>
        </div>
        ...
        <div className="p-4 border-b border-intel-blue/30 flex items-center">
          <div className="w-10 h-10 rounded-full bg-intel-blue flex items-center justify-center">
            <span className="text-lg font-bold">{user?.name?.charAt(0) || 'T'}</span>
          </div>
          <div className="ml-3">
